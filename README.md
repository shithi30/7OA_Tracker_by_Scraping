Unilever e-commerce 7OA KPIs monitoring scripts, include:
...
**Tech Stack:** Language - `Python`, Scraping Libs - `Selenium, BeautifulSoup, requests`, Google Cloud - `GSheets APIs`, Image Analysis - `PIL`
