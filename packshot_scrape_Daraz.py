...
# # newmail.CC = "safa-e.nafee@unilever.com; rafid-al.mahmood@unilever.com"

# # inline
# def inline(fl_names, idx, seq): return f'<img src="cid: MyId' + str(seq) + '" style="display: block; width: 97px; height: 100px; border: 1px solid"><figcaption><b>Fig</b> ' + fl_names[idx][0:7] + "..." + '</figcaption>'
...
#     <tr><td>''' + inline(filenames, 0, 1) + '''</td>
#         <td>''' + inline(filenames, 1, 2) + '''</td>
#         <td>''' + inline(filenames, 2, 3) + '''</td>
#         <td>''' + inline(filenames, 3, 4) + '''</td>
#         <td>''' + inline(filenames, 4, 5) + '''</td></tr>
# </table>
# <br>
...
# <br>
# <table style="margin-left: auto; margin-right: auto">
#     <tr><td>''' + inline(filenames_gm, 0, 6) + '''</td>
#         <td>''' + inline(filenames_gm, 1, 7) + '''</td>
#         <td>''' + inline(filenames_gm, 2, 8) + '''</td>
#         <td>''' + inline(filenames_gm, 3, 9) + '''</td>
#         <td>''' + inline(filenames_gm, 4, 0) + '''</td></tr>
# </table>
# <br>
...
# newmail.Attachments.Add(str(output_dir_gm) + "\\" + filenames_gm[0]).PropertyAccessor.SetProperty("http://schemas.microsoft.com/mapi/proptag/0x3712001F", "MyId6")
# newmail.Attachments.Add(str(output_dir_gm) + "\\" + filenames_gm[1]).PropertyAccessor.SetProperty("http://schemas.microsoft.com/mapi/proptag/0x3712001F", "MyId7")
# newmail.Attachments.Add(str(output_dir_gm) + "\\" + filenames_gm[2]).PropertyAccessor.SetProperty("http://schemas.microsoft.com/mapi/proptag/0x3712001F", "MyId8")
# newmail.Attachments.Add(str(output_dir_gm) + "\\" + filenames_gm[3]).PropertyAccessor.SetProperty("http://schemas.microsoft.com/mapi/proptag/0x3712001F", "MyId9")
# newmail.Attachments.Add(str(output_dir_gm) + "\\" + filenames_gm[4]).PropertyAccessor.SetProperty("http://schemas.microsoft.com/mapi/proptag/0x3712001F", "MyId0")
